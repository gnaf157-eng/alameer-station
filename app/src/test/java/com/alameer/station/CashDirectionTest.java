...
public class CashDirectionTest {
 ...
 @Test public void nameClassificationCancelsCleanlyAndIsRememberedAfterSaving(){
  ...
  CashEntryCard card=new CashEntryCard(new WorkspaceForms(a,a.pages[5],1),box);card.show();Shadows.shadowOf(android.os.Looper.getMainLooper()).idle();card.chooseKind(1);card.person.setText("اتصالات");card.amount.setText("20");card.dialog.getButton(-1).performClick();
