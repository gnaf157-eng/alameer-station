...
public final class Util {
    ...
    public static Button goldButton(android.content.Context c,String text){Button b=button(c,text);b.setTextColor(Color.WHITE);b.setBackgroundTintList(ColorStateList.valueOf(ACCENT));return b;}
