...
public final class Util {
    public static final int NAVY=Color.rgb(10,34,57), NAVY_LIGHT=Color.rgb(22,58,95), GOLD=Color.rgb(200,164,77), GREEN=Color.rgb(18,128,92), RED=Color.rgb(180,35,53), BG=Color.rgb(245,247,250);
    public static String now(){return new SimpleDateFormat("yyyy-MM-dd HH:mm:ss",Locale.US).format(new Date());}
    public static TextView title(android.content.Context c,String text){TextView v=new TextView(c);v.setText(text);v.setTextSize(25);v.setTextColor(Color.WHITE);v.setGravity(Gravity.CENTER);v.setPadding(20,38,20,38);v.setBackground(round(NAVY,22));return v;}
